	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			if ( $game_dev_portfolio_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $game_dev_portfolio_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->

		<nav id="site-navigation" class="main-navigation">
			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'game-dev-portfolio' ); ?></button>
			<?php
			wp_nav_menu( array(
